	...
	class Radium_Theme_Importer {
    	...
    	public function intro_html() {
			...
			<div style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;">
			    <p class="tie_message_hint">Importing the demo data (post, pages, images, widgets, etc.) is the easiest way to setup your theme. It will
			    allow you to quickly edit everything instead of creating content from scratch. Once you click the Import Demo Data button:</p>
			      ...
			      <ul style="padding-left: 20px;list-style-position: inside;list-style-type: square;}">
			          ...
			          <li>Please click import only once and be patient, the process can take a couple of minutes.</li>
			      </ul>
			 </div>
